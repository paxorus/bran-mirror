...
var Department2=Parse.Object.extend("Fall2012");//SEASONAL CHANGE
var dep2=[];
...
body.innerHTML="";
function toLink(num){return "http://www.brandeis.edu/registrar/schedule/classes/2012/Fall/"+num+"/all"}//SEASONAL CHANGE
...
function getCourse(elem){
    ...
    var x=elem.childNodes[11].childNodes[1];
    if(x){
        course.push(abridge(x.innerHTML));//teach
    }else{
        course.push("unlisted");
    }
